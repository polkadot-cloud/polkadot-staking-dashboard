        ...
        <div className="items">
          <div>
            <div className="inner">
              ...
              <h4>
                Estimated APY <OpenHelpIcon title="Estimated APY" />
              </h4>
            </div>
          </div>
          <div>
            <div className="inner">
              ...
              <h4>
                Inflation <OpenHelpIcon title="Inflation" />
              </h4>
            </div>
          </div>
          <div>
            <div className="inner">
              ...
              <h4>
                Supply Staked <OpenHelpIcon title="Supply Staked" />
              </h4>
            </div>
          </div>
          <div>
            <div className="inner">
              ...
              <h4>
                Ideal Staked <OpenHelpIcon title="Ideal Staked" />
              </h4>
            </div>
          </div>
        </div>
